...
def build_jobs(args) -> List[Dict[str, object]]:
    ...
    specs = [
        ("technical_v2_small_ce", "technical_v2_small", "ce"),
        ("technical_v2_small_focal", "technical_v2_small", "focal"),
        ("hybrid_v2_small_ce", "hybrid_v2_small", "ce"),
        ("hybrid_v2_small_focal", "hybrid_v2_small", "focal"),
    ]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate the small technical-probe experiment plan.")
    ...
    parser.add_argument("--output-root", type=Path, default=Path("experiment_runs/late_fusion_technical_small_round"))
